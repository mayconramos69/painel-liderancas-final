...
<header class="topbar modern-topbar">
  <div class="topbar-brand"><span class="mini-logo">L</span><div><small>PAINEL DE LIDERANÇAS</small><strong>Central administrativa</strong></div></div>
...
<main class="container admin-shell">
  ...
  <div class="metrics metrics-six dashboard-metrics">
    ...
    <div class="metric accent"><span class="metric-icon">BU</span><small>Trabalho de BU</small><strong>{{ total_trabalho_bu }}</strong><em>Organização por urna</em></div>
  </div>

  <nav class="section-nav">
    <a href="#liderancas">Lideranças</a><a href="#espontaneos">Espontâneos</a><a href="#trabalho">Trabalho</a><a href="#relatorios">Relatórios</a>
  </nav>

...
def init_db():
    ...
    # Remove campos antigos de pagamento sem afetar os demais cadastros.
    cur.execute("ALTER TABLE usuarios DROP COLUMN IF EXISTS valor_acordado")
    cur.execute("ALTER TABLE usuarios DROP COLUMN IF EXISTS valor_pago")

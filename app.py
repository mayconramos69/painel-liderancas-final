...
def init_db():
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS usuarios (
        ...
        perfil TEXT NOT NULL DEFAULT 'lideranca', status TEXT NOT NULL DEFAULT 'pendente', created_at TEXT NOT NULL)""")
...
def admin():
    ...
    liderancas = conn.execute("""SELECT u.*,
        ...
        FROM usuarios u WHERE u.perfil='lideranca' ORDER BY u.status DESC, u.nome ASC""").fetchall()
    ...
    conn.close()
    return render_template("admin.html", liderancas=liderancas, espontaneos=esp, trabalhos=trab,
